package larc.imphat.runner;

import larc.imphat.data.Synthetic;
import larc.imphat.evaluation.Prediction;
import larc.imphat.model.MultiThreadMPHAT;
import larc.imphat.model.Configure.ModelMode;
import larc.imphat.model.Configure.PredictionMode;

public class Runner {

	static void syntheticDataGeneration(int nUsers, int nPlatform, int nTopics, int nWords, ModelMode mode,
			String outputPath) {
		larc.imphat.data.Synthetic synthetic = new Synthetic(mode);
